...
![XBSL в работе: слева дерево метаданных и палитра компонентов, в центре конструктор формы – структура, данные и каркас, справа панели свойств и документации, снизу исходник yaml](https://raw.githubusercontent.com/keyfire/xbsl/main/editors/vscode/images/overview.png)
...
![Живые диагностики в редакторе и в панели "Проблемы"; лампочка применяет правку, вычисленную линтером](https://raw.githubusercontent.com/keyfire/xbsl/main/editors/vscode/images/lint-quickfix.gif)
