...
и ссылку **Документация**; в конструкторе форм действие *Открыть документацию* есть у элемента
палитры и у свойства в панели свойств. Все они открывают страницу в этой же панели – читать про
незнакомый компонент не нужно уходить из редактора.
