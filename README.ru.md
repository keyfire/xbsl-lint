...
разделы документации платформы) – в [docs/RULES.ru.md](docs/RULES.ru.md); в рантайме –
`xbsl list-rules`. Ниже – обзор по тирам.
...
написанию кода, договорённость включено/выключено) – в [docs/RULES.ru.md](docs/RULES.ru.md).
...
В тексте шаблона живут точки ввода и списки выбора:
